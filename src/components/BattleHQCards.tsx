...
//
//   - Non-Founding with no memberships → nothing (don't clutter the dashboard)
//   - Non-Founding with memberships → "HQs I'm In" only (no create CTA)
//   - Founding with no HQs → "Create your first Battle HQ" CTA
//   - Founding with HQs → "HQs I Run" (+ New HQ btn) + "HQs I'm In" (if any)
//
// Card navigation:
...
export default function BattleHQCards({ subscriptionTier }: BattleHQCardsProps) {
  ...
  // Non-Founding with no memberships → render nothing
  // (Don't tease a feature they can't use.)
  if (!hasAny && !isFounding) {
    return null;
  }
  ...
  return (
    <section className="pt-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-left">
                  ...
                  <p className="text-xs text-zinc-400 leading-relaxed">
                    Build a private command center for your alliance. Battle
                    plans, annotated maps, standing intel — all in one place,
                    shareable by link.
                  </p>
                </div>
              </div>
      ...
      {/* Founding with members but no creations → small inline "+ New HQ" link */}
