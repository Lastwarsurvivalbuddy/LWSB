...
// Last updated: March 31, 2026 — Season 6 Shadow Rainforest added; S1-S4 names added

export type Season = 0 | 1 | 2 | 3 | 4 | 5 | 6;
...
export const SEASON_LABELS: Record<number, string> = {
  ...
  1: 'Season 1 — The Crimson Plague',
  2: 'Season 2 — Polar World',
  3: 'Season 3 — Golden Realm',
  4: 'Season 4 — Evernight Isle',
  5: 'Season 5 — Wild West',
  6: 'Season 6 — Shadow Rainforest',
};
