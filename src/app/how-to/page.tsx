...
const features = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Use the context box to describe your situation in detail — the more you share about your setup, your opponent, and what you think went wrong, the sharper the analysis.',
  ...
  },
  {
    ...
    steps: [
      ...
      'Trim your screenshot to show only the specific pack — crop out surrounding UI.',
      'Upload the cropped screenshot.',
      'Use the context box to add details: what you need most right now, upcoming events, or anything that should factor into the verdict. More context = better recommendation.',
